        ...
        return http
                ...
                .authorizeHttpRequests(auth -> {
                            try {
                                auth
                                        //   -------------------- Access to all API
                                        .requestMatchers(HttpMethod.GET, "/**", "/item/create", "/item/update", "/item/{id}/update").hasAnyRole("ROLE_ADMIN", "ROLE_USER")
                                        .requestMatchers(HttpMethod.POST, "/item/{id}/update").hasAnyRole("ROLE_ADMIN", "ROLE_USER")
                                        //   -------------------- Access for API ASSETS
                                        .requestMatchers(HttpMethod.POST, "/assets/create", "/users/create").hasRole("ROLE_ADMIN")
